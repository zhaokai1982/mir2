...
namespace LibraryViewer
{
    public sealed class MLibrary
    {
        ...
        public void Initialize()
        {
            ...
            if (CurrentVersion < 2)
            {
                MessageBox.Show("版本错误，应为lib版本: " + LibVersion.ToString() + " 找到版本: " + CurrentVersion.ToString() + ".", "未能打开", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                return;
            }
